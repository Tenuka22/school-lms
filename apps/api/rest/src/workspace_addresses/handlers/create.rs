...
pub async fn create_workspace_address(
    ...
    input.street_1 = crate::validation::NonEmpty::new(input.street_1, "street_1")?.into_inner();
    input.city = crate::validation::NonEmpty::new(input.city, "city")?.into_inner();
    input.country = crate::validation::NonEmpty::new(input.country, "country")?.into_inner();
