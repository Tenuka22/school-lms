...
export const OWNERSHIP_PROOF_TYPES = [
  ...
  {
    value: "lease_deed_30yr",
    label: "Lease Deed (30+ years)",
    si: "දීර්ඝ කාලීන බදු ඔප්පු",
  },
  {
    value: "registered_declaration_10yr",
    label: "Registered Declaration (10+ years)",
    si: "පනත් ඉරුමඟින් සනාථ කර ඇති වසර 10+ කට වැඩි ප්‍රකාශන ඔප්පු",
  },
  {
    value: "govt_installment_house",
    label: "Govt Installment House (fully paid, not transferred)",
    si: "රාජා/අර්ධ රාජ්‍ය ආයතනයකින් ගෙවීමේ පදනම මත මිල දී ගෙන සම්පූර්ණ මුදලම ගෙවා අවසන් කර ඇති නමුත් මෙතෙක් අදාළ ආයතන මඟින් එහි හිමිකරු වෙත දේපල පවරා නොමැති නිවාස",
  },
  {
    value: "rental_agreement",
    label: "Rental Agreement",
    si: "ඇනි ගෙවල් කුලී පනත යටතේ ලියාපදිංචි කුලී නිවැසියන් බව සනාථ කරන ලේඛන",
  },
  {
    value: "govt_housing_allocation",
    label: "Govt Housing Allocation Letter",
    si: "රජයේ නිල නිවාස ලේඛනය (දෙපාර්ත මේන්තූ ප්‍රධානිගේ තහවුරු කිරීමේ ලිපිය)",
  },
  {
    value: "govt_installment_receipt",
    label: "Govt/Half-Govt Installment Receipts",
    si: "රාජ්‍ය/අර්ධ රාජ්‍ය ආයතනයකින් ගෙවීමේ පදනම මත මිල දී ගෙන ඇති එහෙත් ගෙවීම අවසන් කර නොමැති නිවාස ලේඛන",
  },
  {
    value: "temple_lease",
    label: "Temple/Devala Religious Lease",
    si: "1931 අංක 19 දරණ විහාර හා දේවාල ගම් පනත යටතේ චාර්ෂික බදු පදනම මත ලබා දී ඇති බදු ඔප්පු",
  },
  {
    value: "govt_land_residence_cert",
    label: "8+ Years on Govt Land (Commissioner/GA Certificate)",
    si: "අයදුම්කරු/කලත්‍රයා අඛණ්ඩ ව වසර 08කට වඩා වැඩි කාලයක් රජයේ ඉඩමක පදිංචි බවට සහතිකය",
  },
  {
    value: "estate_residence_cert",
    label: "Estate Worker Residence Certificate",
    si: "වතු ආශ්‍රිත නිවාසවල පදිංචි බවට වතු අධිකාරී/ප්‍රාදේශීය ලේකම් සහතිකය",
  },
  {
    value: "other_recognized",
    label: "Other Recognized Documents",
    si: "වෙනත් පිළිගත හැකි ලේඛන",
  },
] as const
...
export const SUPPLEMENTARY_PROOF_TYPES = [
  ...
  {
    value: "property_tax_bill",
    label: "Property Tax Bill",
    si: "චරිපනම් බදු බිල්පත්",
  },
          ...
          <div className="flex items-center gap-1">
            {entry?.file_url ? (
              <div className="flex items-center gap-1">
                <Badge
                  variant="secondary"
                  className="max-w-[140px] cursor-pointer gap-1 text-[10px] hover:bg-accent"
                  onClick={() =>
                    setPreviewFile({
                      url: entry.file_url!,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Select the proof documents you have for this address and upload
            files.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave}>Save Proofs ({proofs.length})</Button>
        </DialogFooter>
      </DialogContent>
