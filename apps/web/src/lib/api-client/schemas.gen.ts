...
export const AddressEntrySchema = {
  type: "object",
  required: ["address_id", "address_type", "is_primary", "residence_type"],
  properties: {
    address_id: {
      type: "string",
      format: "uuid",
...
export const BatchStatusSchema = {
  type: "string",
  enum: ["Open", "Closed", "ListsPublished", "AppealsPeriod", "Archived"],
} as const

export const BlacklistSchema = {
  title: "Blacklist",
  type: "object",
  required: ["guardian_id", "reason"],
  properties: {
    application_id: {
      type: "string",
      format: "uuid",
...
export const CreateAddressBodySchema = {
  ...
  type: "object",
  required: ["address_line_1", "city", "district", "gs_division", "province"],
  properties: {
    address_line_1: {
      type: "string",
    },
...
export const CreateStudentResponseSchema = {
  ...
  type: "object",
  required: ["child_id", "student_id", "used_existing_child"],
  properties: {
    child_id: {
      type: "string",
      format: "uuid",
...
export const DistrictSchema = {
  title: "District",
  type: "object",
  required: ["id", "name_en", "name_si", "province"],
  properties: {
    id: {
      type: "string",
      format: "uuid",
...
export const PollingDivisionEntrySchema = {
  ...
  type: "object",
  required: ["district", "label", "si", "value"],
  properties: {
    district: {
      type: "string",
    },
...
export const ResidenceTypeSchema = {
  type: "string",
  enum: ["Owned", "Rented", "Relative", "Other"],
} as const
