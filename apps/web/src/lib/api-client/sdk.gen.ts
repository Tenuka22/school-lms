...
import type {
  CalculateMarksData,
  CalculateMarksErrors,
  CalculateMarksResponses,
  ...
  GetApplicationWorkspaceAddressesErrors,
  GetApplicationWorkspaceAddressesResponses,
  GetBatchData,
  GetBatchErrors,
  GetBatchResponses,
  GetCounterData,
...
import {
  vCalculateMarksPath,
  vCalculateMarksResponse,
  vCreateApplicationBody,
  ...
  vGenerateAdmissionListsBody,
  vGenerateAdmissionListsResponse,
  ...
  vGetApplicationWorkspaceAddressesPath,
  vGetApplicationWorkspaceAddressesResponse2,
  vGetBatchPath,
  vGetBatchResponse,
  vGetCounterPath,
  vGetCounterResponse,
  ...
  vSaveWorkspaceAddressesPath,
  vSaveWorkspaceAddressesResponse2,
...
export const calculateMarks = <ThrowOnError extends boolean = false>(
  options: Options<CalculateMarksData, ThrowOnError>
): RequestResult<CalculateMarksResponses, CalculateMarksErrors, ThrowOnError> =>
  (options.client ?? client).post<
    CalculateMarksResponses,
    CalculateMarksErrors,
    ThrowOnError
  >({
    ...
    responseValidator: async (data) =>
      await v.parseAsync(vCalculateMarksResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/g1-applications/{id}/calculate-marks",
    ...options,
  })

export const generateAdmissionLists = <ThrowOnError extends boolean = false>(
  options: Options<GenerateAdmissionListsData, ThrowOnError>
): RequestResult<
  GenerateAdmissionListsResponses,
  GenerateAdmissionListsErrors,
  ThrowOnError
> =>
  ...
  >({
    ...
    responseValidator: async (data) =>
      await v.parseAsync(vGenerateAdmissionListsResponse, data),
    security: [{ scheme: "bearer", type: "http" }],
...
>(
  options: Options<GetApplicationWorkspaceAddressesData, ThrowOnError>
): RequestResult<
  GetApplicationWorkspaceAddressesResponses,
  GetApplicationWorkspaceAddressesErrors,
  ThrowOnError
> =>
  ...
  >({
    ...
    responseValidator: async (data) =>
      await v.parseAsync(vGetApplicationWorkspaceAddressesResponse2, data),
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/g1-applications/{id}/workspace-addresses",
    ...options,
  })

export const saveWorkspaceAddresses = <ThrowOnError extends boolean = false>(
  options: Options<SaveWorkspaceAddressesData, ThrowOnError>
): RequestResult<
  SaveWorkspaceAddressesResponses,
  SaveWorkspaceAddressesErrors,
  ThrowOnError
> =>
  ...
  >({
    ...
    responseValidator: async (data) =>
      await v.parseAsync(vSaveWorkspaceAddressesResponse2, data),
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/g1-applications/{id}/workspace-addresses",
    ...options,
    headers: {
