...
import { InterviewShell } from "@/components/enrollment/g1/interview/interview-shell"
...
export const Route = createFileRoute(
  ...
  loader: async ({ context, params }) => {
    ...
    await Promise.all([
      ...
      queryClient.ensureQueryData(listStudentsOptions({ client: apiClient })),
      queryClient.ensureQueryData(listSchoolsOptions({ client: apiClient })),
